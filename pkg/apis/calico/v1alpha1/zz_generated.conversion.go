...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*EgressFilter)(nil), (*calico.EgressFilter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_EgressFilter_To_calico_EgressFilter(a.(*EgressFilter), b.(*calico.EgressFilter), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*calico.EgressFilter)(nil), (*EgressFilter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_calico_EgressFilter_To_v1alpha1_EgressFilter(a.(*calico.EgressFilter), b.(*EgressFilter), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_EgressFilter_To_calico_EgressFilter(in *EgressFilter, out *calico.EgressFilter, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_v1alpha1_EgressFilter_To_calico_EgressFilter is an autogenerated conversion function.
func Convert_v1alpha1_EgressFilter_To_calico_EgressFilter(in *EgressFilter, out *calico.EgressFilter, s conversion.Scope) error {
	return autoConvert_v1alpha1_EgressFilter_To_calico_EgressFilter(in, out, s)
}

func autoConvert_calico_EgressFilter_To_v1alpha1_EgressFilter(in *calico.EgressFilter, out *EgressFilter, s conversion.Scope) error {
	out.Enabled = in.Enabled
	return nil
}

// Convert_calico_EgressFilter_To_v1alpha1_EgressFilter is an autogenerated conversion function.
func Convert_calico_EgressFilter_To_v1alpha1_EgressFilter(in *calico.EgressFilter, out *EgressFilter, s conversion.Scope) error {
	return autoConvert_calico_EgressFilter_To_v1alpha1_EgressFilter(in, out, s)
}
...
func autoConvert_v1alpha1_NetworkConfig_To_calico_NetworkConfig(in *NetworkConfig, out *calico.NetworkConfig, s conversion.Scope) error {
	...
	out.EgressFilter = (*calico.EgressFilter)(unsafe.Pointer(in.EgressFilter))
